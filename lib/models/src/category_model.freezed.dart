...
mixin _$CategoryModel {
  ...
  int get activated => throw _privateConstructorUsedError;
...
class _$_CategoryModel implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, description: $description, activated: $activated, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, activated, createdAt, updatedAt);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      required final int activated,
      final String? createdAt,
      final String? updatedAt}) = _$_CategoryModel;
